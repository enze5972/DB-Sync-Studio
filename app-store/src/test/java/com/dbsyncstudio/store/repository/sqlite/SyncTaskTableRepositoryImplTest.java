...
public class SyncTaskTableRepositoryImplTest {
    ...
    public void shouldPersistAndLoadTaskTables() throws Exception {
        ...
        SyncTaskTableRepositoryImpl repository =
                new SyncTaskTableRepositoryImpl(new DatabaseConnectionFactory(tempDatabase));
        repository.initialize();

        SyncTaskTableDO table = new SyncTaskTableDO();
        ...
        Optional<SyncTaskTableDO> loaded = repository.findById(id);
        ...
        List<SyncTaskTableDO> byTaskId = repository.findByTaskId(42L);
