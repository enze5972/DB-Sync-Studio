...
public class SqliteDatasourceRepositoryTest {
    ...
    public void shouldSaveAndLoadDatasourceConfig() throws Exception {
        ...
        SqliteDatasourceRepository repository = new SqliteDatasourceRepository(new SqliteConnectionFactory(tempDatabase));
        ...
        Optional<DatasourceConfig> loaded = repository.findById(id);
        ...
        List<DatasourceConfig> all = repository.findAll();
