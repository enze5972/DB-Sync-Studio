...
public class SqliteSchemaComparisonHistoryRepositoryTest {
    ...
    public void shouldPersistAndLoadRecentSchemaComparisonHistory() throws Exception {
        ...
        SqliteSchemaComparisonHistoryRepository repository =
                new SqliteSchemaComparisonHistoryRepository(new SqliteConnectionFactory(tempDatabase));
        repository.initialize();

        SchemaComparisonHistoryEntry firstEntry = new SchemaComparisonHistoryEntry();
        ...
        SchemaComparisonHistoryEntry secondEntry = new SchemaComparisonHistoryEntry();
        ...
        List<SchemaComparisonHistoryEntry> recent = repository.findRecent(20);
